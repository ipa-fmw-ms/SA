...
\newcommand{\Subject}{Entwicklung einer Webapplikation zur automatischen Verteilung von Gütern}
...
%numerate tables
\usepackage{array}
\newcounter{rowno}%zähler für zeilen
% UML
...
% Einrückung der ersten Zeile eines Absatzes unterdrücken
...
% Damit Bilder möglichst da sind, wo man sie will
...
\setlength{\nomlabelwidth}{.24\hsize} % Punkte zw. Abkürzung und Erklärung
\renewcommand{\nomlabel}[1]{#1 \dotfill}
...
% Rändereinstellungen fuer Doppelseitigen Ausdruck
\evensidemargin=2pt
\oddsidemargin=40pt
...
% Eidesstattliche Erklärung einfügen
%\include{berichterkl}
%\thispagestyle{empty}\cleardoublepage
...
\include{berichtapp} % Anhang einfügen
%\thispagestyle{empty}\cleardoublepage
\include{berichtlof} % Abbildungsverzeichnis einfügen
%\thispagestyle{empty}\cleardoublepage
\include{berichtloc} % Quellcodeverzeichnis einfügen
%\thispagestyle{empty}\cleardoublepage
\include{berichtlot} % Tabellenverzeichnis einfügen
%\thispagestyle{empty}\cleardoublepage

% Literaturverzeichnis einfügenArchitekturbild 1
\phantomsection
